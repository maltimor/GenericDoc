...
public class Cas20ServiceTicketValidator extends AbstractCasProtocolUrlBasedTicketValidator {
    ...
    protected final void populateUrlAttributeMap(final Map<String,String> urlParameters) {
    	System.out.println("C20.populateUrlAttributeMap:"+urlParameters);
    ...
    protected final Assertion parseResponseFromServer(final String response) throws TicketValidationException {
    	System.out.println("C20.parseResponseFromServer:"+response);
    ...
    protected Map<String,Object> extractCustomAttributes(final String xml) {
    	System.out.println("C20.extractCustomAttributes:"+xml);
    ...
    protected void customParseResponse(final String response, final Assertion assertion) throws TicketValidationException {
        // nothing to do
    	System.out.println("C20.customParseResponse:"+response);
    }

    public final void setProxyCallbackUrl(final String proxyCallbackUrl) {
    	System.out.println("C20.setProxyCallbackUrl:"+proxyCallbackUrl);
        this.proxyCallbackUrl = proxyCallbackUrl;
    }

    public final void setProxyGrantingTicketStorage(final ProxyGrantingTicketStorage proxyGrantingTicketStorage) {
    	System.out.println("C20.setProxyGrantingTicketStorage:"+proxyGrantingTicketStorage);
        this.proxyGrantingTicketStorage = proxyGrantingTicketStorage;
    }

    public final void setProxyRetriever(final ProxyRetriever setProxyRetriever) {
    	System.out.println("C20.setProxyRetriever:"+setProxyRetriever);
